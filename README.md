# [INF4167] Proyek SOLID OOP Python
## Pertemuan 12: Dokumentasi dan Version Control

### Deskripsi Proyek
Proyek ini mendemonstrasikan implementasi prinsip SOLID (SRP, OCP, DIP) pada sistem checkout dengan menggunakan Abstract (Interface) dan Dependency Injection.

### Struktur File
- 'refactor_solid.py': Kode inti yang sudah direfaktor, ditambahkan logging, dan juga docstring.
- 'studi_kasus.py': Latihan mandiri
